...
while (pregunta === "si") {
  ...
  let categoria = prompt( "¿En qué categoría se encaja ese alimento? (1: frutas, 2: lacteos, 3: congelados, 4: dulces, 5: verduras)");
  if (categoria === "1") {
  ...
  pregunta = prompt("¿Deseas agregar otro alimento a tu lista de compras? (si/no)");
}
